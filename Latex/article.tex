...
In a similar vein, \cite[284]{Brems2003} also considers nouns as measure nouns \textit{which, strictly speaking, do not designate a `measure', but display a more nebulous} (\textit{sic!}) \textit{potential for quantification}.
...
This section therefore reviews some existing analyses of the PGC-NAC alternation or related issues, including generative approaches.

% Grammaticalisation (Brems, Rutkowski)
