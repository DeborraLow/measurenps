...
In the masculine\slash neuter model individual measure lemmas do not play much of role, mostly because the second-level regressors successfully model the between-lemma variance.
In the feminine model, kind lemmas (and -- as will be shown -- the second level model for kind lemmas) are irrelevant, most likely because of the low number of levels.%
...
\begin{figure}[h!]
  ...
  \caption{Effect plot for the regressor \textit{Kindattraction} for the masculine\slash neuter and the feminine model (y axes have different scales)}
...
\begin{figure}[h!]
  ...
  \caption{Effect plot for the regressor \textit{Measureattraction} for the masculine\slash neuter and the feminine model (y axes have different scales)}
...
\begin{figure}[h!]
  ...
  \caption{Effect plot for the regressor \textit{Measureclass} for the masculine\slash neuter model}
  \label{fig:eff:measureattraction}
\end{figure}
...
%  \caption{Effect plot for the regressor \textit{Minus1pos} for the masculine\slash neuter and the feminine model (y axes have different scales)}
%  \label{fig:eff:measureattraction}
%\end{figure}
%
%\begin{figure}[h!]
...
%  \caption{Effect plot for the regressor \textit{Measurenumber} for the masculine\slash neuter and the feminine model (y axes have different scales)}
%  \label{fig:eff:measureattraction}
%\end{figure}
