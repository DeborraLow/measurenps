...
\begin{document}
  ...
  \abstract{In this paper, a case alternation occurring in German measure noun phrases is examined from the perspective of cognitively oriented corpus linguistics.
    ...
    I assume that the variants are modelled after non-alternating neighbouring constructions, which represent the prototypes more clearly.
    Primarily, it is argued that the frequencies with which individual lemmas appear in the prototypical constructions partially predicts which variant is chosen in the alternating case, and that the genitive construction is prototypical of more strongly grammaticalised measure nouns.
    ...
    In both experiments, the usage-based corpus analysis is successfully correlated with the behaviour of cognitive agents.
...
The hundredth selected mass noun was \textit{Schmuck} `jewellery’, which is the $3,054$th most frequent noun in the original frequency list.
