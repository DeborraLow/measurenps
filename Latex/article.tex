...
\SetWatermarkText{\parbox{12cm}{\centering\sffamily\LARGE Final draft, to appear in Cognitive Linguistics.\\Please quote as such.}}
\SetWatermarkColor{red}
\SetWatermarkHorCenter{0.65\paperwidth}
\SetWatermarkVerCenter{0.85\paperheight}
\SetWatermarkAngle{0}
