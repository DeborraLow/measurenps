...
% \SetWatermarkColor[rgb]{0.9,0.2,0.2}
% \SetWatermarkText{\textsf{Revision 2}}
...
\begin{acknowledgement}
  ...
  Also, I would like to thank the three reviewers for Cognitive Linguistics as well as associate editor Dagmar Divjak for insightful comments which helped to improve the quality of this paper significantly.
