...
\begin{document}
  ...
  \abstract{In this paper, a case alternation occurring in German measure noun phrases is examined from the perspective of cognitively oriented corpus linguistics.
    ...
    I assume that the variants are modelled after non-alternating neighbouring constructions, which represent the prototypes more purely.
    Primarily, it is argued that the frequencies with which individual lemmas occur in the prototypical constructions partially predict which variant is chosen in the alternating case.
...
In the case at hand, three different syntactic configurations need to be distinguished \wrt case assignment inside German MNPs.
...
%  \begin{xlist}
    \ex[ ]{\label{ex:intro:pseudopartitive1}\gll Wir trinken [[eine Glas]\Sub{Acc} [dieses Weins]\Sub{Gen}]\Sub{Acc}.\\
...
Overviews can be found in \citealp{Hentschel1993} and \citealp{Zimmer2015}.
