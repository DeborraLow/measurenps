...
The classification was designed inspired by the list in \cite[530]{Koptjevskaja2001}, but due to the frequencies of the respective nouns, very coarse classes were necessary.
...
\begin{sidewaystable}
  \centering
    \begin{tabular}{lllrrrrrrrcc}
    Level     & Regressor         & Level     & \pPB  & \multicolumn{2}{l}{Coefficient} & \multicolumn{2}{l}{CI Low} & \multicolumn{2}{l}{CI High} & \multicolumn{2}{l}{CI contains 0} \\
    ...
    First     & Badness           & (numeric) & 0.001 & -0.165 & -0.169 & -0.264 & -0.264 & -0.074 & -0.075 &      * &      * \\
              & Genitives         & (numeric) & 0.001 & -0.630 & -0.645 & -0.710 & -0.739 & -0.523 & -0.552 &      * &      * \\
              & Leftcontext       & D         & 0.001 &  1.178 &  1.173 &  0.751 &  0.784 &  1.548 &  1.546 &      * &      * \\
              &                   & O         &       &  1.561 &  1.588 &  1.093 &  1.179 &  1.919 &  2.007 &      * &      * \\
              &                   & A         &       &  2.300 &  2.340 &  1.872 &  1.959 &  2.644 &  2.726 &      * &      * \\
              &                   & P         &       &  2.353 &  2.371 &  1.693 &  1.766 &  2.900 &  2.978 &      * &      * \\
              & Measurecase       & Acc       & 0.001 &  0.065 &  0.070 & -0.130 & -0.119 &  0.268 &  0.269 &        &        \\
              &                   & Dat       &       &  0.707 &  0.735 &  0.413 &  0.480 &  0.959 &  1.002 &      * &      * \\
	      & Measurenumber     & Pl        & 0.001 &  0.814 &  0.825 &  0.534 &  0.574 &  1.080 &  1.079 &      * &      * \\[0.5\baselineskip]

    Second    & Kindattraction    & (numeric) & 0.033 &  0.204 &  0.216 &  0.030 &  0.014 &  0.366 &  0.412 &      * &      * \\
    (Kind)    & Kindfreq          & (numeric) & 0.066 &  0.161 &  0.173 & -0.008 &  0.009 &  0.333 &  0.350 &        &      * \\
              & Kindgender        & Neut      & 0.001 & -0.007 & -0.022 & -0.407 & -0.424 &  0.408 &  0.379 &        &        \\
	      &                   & Fem       &       &  1.357 &  1.379 &  0.831 &  0.872 &  1.808 &  1.897 &      * &      * \\[0.5\baselineskip]
              
    Second    & Measureattraction & (numeric) & 0.015 &  0.247 &  0.275 &  0.058 &  0.078 &  0.413 &  0.476 &      * &      * \\
    (Measure) & Measureclass      & Rest      & 0.001 &  0.564 &  0.488 & -0.140 & -0.309 &  1.197 &  1.236 &        &        \\
              ...
              & Measurefreq       & (numeric) & 0.003 & -0.257 & -0.264 & -0.413 & -0.435 & -0.098 & -0.099 &      * &      * \\
  \end{tabular}
  \smallskip
...
The resulting 95\% bootstrap confidence intervals are reported in Table~\ref{tab:bigtable} in the columns labelled \textit{CI Low} and \textit{CI High} (for the upper and lower 2.5th percentiles).
The column \textit{CI contains 0} shows an asterisk for those intervals that do not include 0 as a more modest replacement of significance levels.
...
All regressors have low \pPB\ values of magnitude $10^{-2}$ and $10^{-3}$, and only \textit{Kindattraction} ($p_{\text{PB}}=0.033$) and \textit{Kindfreq} ($p_{\text{PB}}=0.066$) can be seen as slightly too high to be convincing (`non-significant').
...
Since both methods lead to exactly the same results (minus negligible numerical differences) as expected (see Section~\ref{sec:rightstatistics}), I only interpret the MLE model in the next section.
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.75\textwidth]{../R/output/corpus_Measureattraction}
  \caption{Effect plot for the regressor \textit{Measureattraction}}
  \label{fig:eff:measureattraction}
\end{figure}

First, the prototypicality effect related to the non-alternating \PGCd\ and \NACb\ can be shown, see the effect plots in Figure~\ref{fig:eff:measureattraction}.%
...
Figure~\ref{fig:eff:leftcontext} shows, however, that the left context of the measure noun influences the choice of the variant (in both models, the regressor has $p=0.002$).
