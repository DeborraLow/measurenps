...
\SetWatermarkFontSize{18pt}
\SetWatermarkHorCenter{300pt}
\SetWatermarkColor[rgb]{0.1,0.1,0.7}
\SetWatermarkText{\textsf{Final revision. To appear in COGL. Notification of acceptance is attached.}}
...
% \setlength\linenumbersep{20pt}
  ...
  \journalname{To appear in Cognitive Linguistics}
  %\journalyear{}
  %\journalvolume{...}
  %\journalissue{...}
  %\startpage{...}
