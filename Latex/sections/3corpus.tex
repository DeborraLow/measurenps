...
This show that the main prototypical factors \textit{Cardinal} and \textit{Measureclass} indeed play the predicted role
...
%The corresponding regressor did not even reach sig=0.1 in the PBmodcomp test.
