...
A closer look at the results in the form of the spineplot in Figure~\ref{fig:spines} shows, however, that it was likely an idiosyncracy of the sentence with a model prediction between 0.5 and 0.6 which spoiled an otherwise much better correlation.
...
This obviously influences the reactions of participants, and I will return to this in the discussion in Section~\ref{sec:conclusion}.
...
In principle, random slope for \textit{Modelprediction} varying by stimulus could also remedy problems with individual stimuli at least partially.
